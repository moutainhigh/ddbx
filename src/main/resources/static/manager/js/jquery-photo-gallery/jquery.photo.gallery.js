 ...
 * @LastEditTime: 2019-03-09 14:34:09
 */
(function($) {
    ...
    $.extend({
        ...
        openPhotoGallery: function(obj) {
            ...
            $("#xmove_ttjpgj").remove();
            $("#J_pg").remove();
            var nh = (document.body.clientHeight - winHeight) / 2 - 260;
        ...
        initGallery: function() {
            ...
            $(_stid).mousedown(function(e) {
                var isMove = true;
                var div_x = e.pageX - $(_stidup).offset().left;
                var div_y = e.pageY - $(_stidup).offset().top;
                ...
                $(document).mousemove(function(e) {
                    if (isMove) {
                        var obj = $(_stidup);
                        obj.css({
                            "left": e.pageX - div_x + $(_stidup).offset().left,
                            "top": e.pageY - div_y + $(_stidup).offset().top
                        });
                    }
                }).mouseup(
                    function() {
