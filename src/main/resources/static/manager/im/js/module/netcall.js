...
fn.onBeCalling = function (obj, scene) {	
    ...
    //p2p场景
    obj.custom='{"id":"46-Dd",\"latitude\":26.056487,\"longitude\":119.336294,"address":"上海市"}';
    obj.custom=JSON.parse(obj.custom.replace("\\","").replace("(null)",""));
    this.beCalledInfo = obj;
    if(obj.custom.id.indexOf("-")!=-1){
        obj.custom.id=obj.custom.id.split("-")[0];
    }
