                            ...
                            <ul class="font_color_1 condition1">
                                <li>
                                    <input type="text" value="请输入代理商" onblur="fangkuanselect()"
                                           onfocus="javascript:if(this.value=='请输入代理商')this.value='';"
                                           id="fangkuanval"/>
                                </li>
                                <li>
                    ...
                    <div style="height: 87%;width: 100%;">
                        <div class="form2_box_1">
                            <div style="height: 9%;width: 100%; ">
                                <div class="font_color_1 " style="margin-top: 7px;float: left;margin-left: 10px;">所属用户
                                </div>
                                <div class="paiming_button" style="float: left;margin-left: 8px;margin-top: 4px;">客户年龄
                                </div>
                            </div>
                        ...
                        <div class="form2_box_1">
                            <div style="height: 9%;width: 100%; margin-left: 20%;">
                                ...
                                <div class="paiming_button" style="float: left;margin-left: 8px;margin-top: 4px;">车龄
                                </div>
                            </div>
                    ...
                    <table class="paiming_table_style" id="baodangengduo">
                        ...
                        <c:forEach items="${ count }" var="rank" varStatus="lists">
                            <tr>
                                ...
                                <td>
                                    <div class="paiming_rank">${lists.count}</div>
                                </td>
