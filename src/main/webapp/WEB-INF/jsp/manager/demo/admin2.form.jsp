            ...
            <div class="box-body">
                        ...
                        <div class="row inline-from">
                            ...
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="jszid" name="jszid"
                ...
                <div class="box-body">
                    ...
                    <span class="input-group-addon">
                      <a href="javascript:domscapi(1);">点击查询</a>
                                        ...
                                        <input id="cbs_orderid__" name="cbs_orderid__" type="text" readonly
                                               value="点击后等结果,勿重复点" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <span class="input-group-addon">
                  <a href="javascript:docbsapi(1);">点击查询</a>
                                ...
                                <input id="cbs_orderid__" name="cbs_orderid__" type="text" readonly
                                       value="点击查询后等待出结果，有可能需要等待30-60秒，勿重复点击。如提示「数据正在准备中，请稍候」,那么等1，2分钟重新点击下！"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea style="width: 100%; height: 100px" class="form-control" name="wxbyxx_item1"
                                      id="wxbyxx_item1"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                        ...
                        <div class="row inline-from">
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <select name="bc_status" class="form-control" id="bc_status"
                                            onchange="autoremark();">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea style="width: 100%; height: 30px" class="form-control" name="textvin"
                                  id="textvin"></textarea>
                    </div>
                    <label class="col-sm-2 control-label">API 询违章查结果：</label>
                    <div class="col-sm-4">
                        <textarea style="width: 100%; height: 30px" class="form-control" name="textwz"
                                  id="textwz"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea style="width: 100%; height: 30px" class="form-control" name="textkf"
                                  id="textkf"></textarea>
                    </div>
                    <label class="col-sm-2 control-label">OCR行驶证：</label>
                    <div class="col-sm-4">
                        <textarea style="width: 100%; height: 30px" class="form-control" name="textxsz"
                                  id="textxsz"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea style="width: 100%; height: 30px" class="form-control" name="textjsz"
                                  id="textjsz"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea style="width: 100%; height: 50px" class="form-control" name="cbstext"
                                  id="cbstext"></textarea>
                    </div>
                </div>
            </div>
