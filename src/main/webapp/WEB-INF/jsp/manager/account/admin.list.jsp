									...
									<td class="user-table-info text-center">
										<div class="media">
											<div class="media-left hidden-xs">
												<a href="${Tools.myIsNull(u.avatarurl)?"images/face.png":u.avatarurl}" target="_blank" class="user-face-pic">
												<img class="media-object" src="${Tools.myIsNull(u.avatarurl)?"images/face.png":u.avatarurl}" style="width: 36px;height:36px;">
											</a></div>
