...
<c:if test="${fn:contains(sessionScope.strAgp,',112,')==true}">
<div class="text-primary">
    ...
    <div class="big-conte_">
        ...
        <div class="task_margin ng-scope"  style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form id="gsgdsh_68" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
		...
		<div class="col-sm-3">
			<input class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text" value="${icbc.order_code}>
                ...
                <div class="modal-footer">
                    ...
                    <a onclick="erp_gsgdsh_68()"  class="btn btn-primary" >提交</a>
                </div>
            </form>
