...
<c:if test="${fn:contains(sessionScope.strAgp,',73,')==true}">
        ...
        <div class="task_margin ng-scope" style="border: 1px solid #ccc; border-radius: 10px; background-color: #F7F7F7; padding-top: 10px;">
            <form name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope" cg-disabled="detail">
                ...
                <div class="form-group ng-scope" ng-if="notUseButton">
                    ...
                    <div class="col-sm-6">
                        <input type="radio" value="1" ng-model="task.checkRet" id="result_code1" name="result_code" class="ng-pristine ng-untouched ng-valid ng-not-empty">过件&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" value="2" ng-model="task.checkRet" id="result_code2" name="result_code" class="ng-pristine ng-untouched ng-valid ng-not-empty">过件附条件&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" value="3" ng-model="task.checkRet" id="result_code3" name="result_code" class="ng-pristine ng-untouched ng-valid ng-not-empty">回退补件
                    </div>
                </div>
