...
<div class="text-primary">
    ...
    <div class="big-conte_">
        ...
        <div class="task_margin ng-scope"  style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form id="tdtfsh_88" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" style="margin-left: 3%">退单退费材料</label>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <a onclick="erp_tdtfsh_88()"  class="btn btn-primary" >提交</a>
                </div>
            </form>
            <script type="text/javascript">
                function erp_tdtfsh_88(){
                    var val=$('input:radio[name="result_1_code"]:checked').val();
                    if(val==null){
                        alert("请选择审核结果!");
                        return false;
                    }else{
                        var form = new FormData(document.getElementById("tdtfsh_88"));
                        $.ajax({
                            url:"${pageContext.request.contextPath}/erp/erp_tdtfsh_88.do",
                            type:"post",
                            data:form,
                            processData:false,
                            contentType:false,
