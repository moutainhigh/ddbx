                                ...
                                <div class="form-group ng-scope">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="radio" value="1" checked="checked"
                                               onchange="showradio('3362',this.value)" id="33621" name="33621"
                                               class="ng-pristine ng-untouched ng-valid ng-not-empty">评估完成
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" value="2" onchange="showradio('3362',this.value)" id="33622"
                                               name="33622" class="ng-pristine ng-untouched ng-valid ng-not-empty">拒绝
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" value="3" onchange="showradio('3362',this.value)" id="33623"
                                               name="33623" class="ng-pristine ng-untouched ng-valid ng-not-empty">回退补件
                                    </div>
                                </div>
			...
			<div class="col-sm-3">
				<div class="input-group date ng-isolate-scope ng-not-empty ng-valid ng-valid-required">
					<input class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text"
                           name="price_new" value=""><span class="input-group-addon">元</span>
				</div>
			</div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date ng-isolate-scope ng-not-empty ng-valid ng-valid-required">
                                                <input class="form-control ng-pristine ng-untouched ng-valid ng-not-empty"
                                                       type="text" name="icbc_pricecs" value=""><span
                                                    class="input-group-addon">元</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <!-- ngIf: currentUser.orgType!='HAFU' --><span
                                            ng-if="currentUser.orgType!='HAFU'" class="ng-scope">
			<label class="col-sm-2 control-label">建议评估价</label>
			<div class="col-sm-3">
				<div class="input-group date ng-isolate-scope ng-not-empty ng-valid ng-valid-required">
					<input class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text"
                           value=""><span class="input-group-addon">元</span>
				</div>
			</div>
		</span><!-- end ngIf: currentUser.orgType!='HAFU' -->
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group date ng-isolate-scope ng-not-empty ng-valid ng-valid-required">
                                                <input class="form-control ng-pristine ng-untouched ng-valid ng-not-empty ng-valid-required"
                                                       type="text" id="price_result" name="price_result" value=""><span
                                                    class="input-group-addon">元</span>
                                            </div>
                                        </div>
                                    </div>
