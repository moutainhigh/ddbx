        ...
        <div class="task_margin ng-scope"  style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form id="tdtfsh_91" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input name="tdtfsh_91_dze" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text">
                    </div>
                    <label class="col-sm-2 control-label">资金占有费</label>
                    <div class="col-sm-3">
                        <input name="tdtfsh_91_zjzyf" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <a onclick="erp_tdtfsh_91()"  class="btn btn-primary" >提交</a>
                </div>
            </form>
            <script type="text/javascript">
                function erp_tdtfsh_91(){
                    var form = new FormData(document.getElementById("tdtfsh_91"));
                    $.ajax({
                        url:"${pageContext.request.contextPath}/erp/erp_tdtfsh_91.do",
                        type:"post",
                        data:form,
                        processData:false,
                        contentType:false,
