        ...
        <div class="task_margin ng-scope" style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="receiptConfirm" name="receiptConfirm" type="radio" ${result_map.receiptConfirm eq '已收到'?"checked":''} value="已收到"  class="ng-pristine ng-untouched ng-valid ng-not-empty" >已收到
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="receiptConfirm" name="receiptConfirm" type="radio" ${result_map.receiptConfirm eq '未收到'?"checked":''} value="未收到"  class="ng-pristine ng-untouched ng-valid ng-not-empty" name="yhdksh_58_msg">未收到
                    </div>
                    ...
                    <input type="hidden" id="receiptDate" name="receiptDate" value="" /><br/>
                </div>
                <div class="form-group">
