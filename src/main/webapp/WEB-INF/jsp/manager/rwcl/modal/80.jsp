        ...
        <div class="task_margin ng-scope" style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="" name="" type="radio" value="已收到" ${result_map.receiptConfirm eq '已收到'?"checked":''}  class="ng-pristine ng-untouched ng-valid ng-not-empty" >已收到
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="" name="" type="radio" value="未收到" ${result_map.receiptConfirm eq '未收到'?"checked":''}  class="ng-pristine ng-untouched ng-valid ng-not-empty" name="yhdksh_58_msg">未收到
                    </div>
                    <label class="col-sm-2 control-label">收件日期<i class="pull-right text-red">*</i></label>
                    <div style="padding-left:15px;" class="input-group date form_datetime col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-field="receiptDate">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="" name="" ${result_map.materialResult eq 1?"checked":''} type="radio" value="1" class="ng-pristine ng-untouched ng-valid ng-not-empty">通过
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="" name="" ${result_map.materialResult eq 2?"checked":''} type="radio" value="2" class="ng-pristine ng-untouched ng-valid ng-not-empty">不通过
                    </div>
                    <label class="col-sm-2 control-label">车牌号码<i class="pull-right text-red">*</i></label>
                    <div class="col-sm-3">
                         <input id="" name="" value="${result_map.carNo}" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">备注</label>
                    <div class="col-sm-8">
                        <textarea name="" id="" rows="3" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text" ng-model="task.remarks"><%=result_map.get("result_msg")%></textarea>
                    </div>
                </div>
            </form>
        </div>
