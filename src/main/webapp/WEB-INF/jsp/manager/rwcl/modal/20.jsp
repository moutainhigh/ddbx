                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <label class="radio-inline">
                            <input type="radio" value="1" ${result_map.result_code eq 1?"checked":''} name="result_code">开卡成功
                        </label>
                        <label class="radio-inline">
                            <input type="radio" value="2" ${result_map.result_code eq 2?"checked":''} name="result_code">开卡失败
                        </label>
                        <label class="radio-inline">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group date">
                            <input class="form-control" disabled placeholder="" id="" name="" value="${result_map.kk_date}"
                                   type="text" lay-key="1">
                    ...
                    <div class="col-sm-3">
                        <input disabled value="${result_map.kk_kh}"
