        ...
        <div class="task_margin ng-scope" style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope ng-valid-required">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">合同编码<i class="pull-right text-red">*</i></label>
                    <div class="col-sm-3">
                        <input id="" name="" value="${result_map.contractCode}" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div style="padding-left:15px;" class="input-group date form_datetime col-md-3" data-date="" data-date-format="yyyy-mm-dd" data-link-field="sendDate">
