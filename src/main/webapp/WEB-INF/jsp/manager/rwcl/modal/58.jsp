        ...
        <div class="task_margin ng-scope" style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input id="receiptConfirm" name="receiptConfirm" ${result_map.receiptConfirm eq '已收到'?"checked":''} type="radio" value="已收到"  class="ng-pristine ng-untouched ng-valid ng-not-empty" >已收到
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="receiptConfirm" name="receiptConfirm" ${result_map.receiptConfirm eq '未收到'?"checked":''} type="radio" value="未收到"  class="ng-pristine ng-untouched ng-valid ng-not-empty" name="yhdksh_58_msg">未收到
                    </div>
                    ...
                    <input type="hidden" id="receiptDate" name="receiptDate" value="${result_map.receiptDate}" /><br/>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">材料复核结果<i class="pull-right text-red">*</i></label>
                    <div class="col-sm-3">
                        <input id="materialResult" name="materialResult" type="radio" ${result_map.materialResult eq 1?"checked":''} value="1" class="ng-pristine ng-untouched ng-valid ng-not-empty">通过
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="materialResult" name="materialResult" type="radio" ${result_map.materialResult eq 2?"checked":''} value="2" class="ng-pristine ng-untouched ng-valid ng-not-empty">不通过
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="result_msg" id="result_msg" rows="3" class="form-control ng-pristine ng-untouched ng-valid ng-not-empty" type="text" ng-model="task.remarks"><%=result_map.get("result_msg")%></textarea>
                    </div>
                </div>
            </form>
        </div>
