        ...
        <div class="task_margin ng-scope"  style="border:1px solid #ccc; border-radius: 10px;background-color:#F7F7F7; padding-top:10px;">
            <form id="yhdksh_63" name="modalForm" class="form-horizontal ng-pristine ng-valid ng-scope">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="" id="" ${result_map.result_code eq 1?"checked":''} class="ng-pristine ng-untouched ng-valid ng-not-empty" type="radio" value="1">完整
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="" id="" ${result_map.result_code eq 2?"checked":''} class="ng-pristine ng-untouched ng-valid ng-not-empty" type="radio" value="2">材料不完整，需要机构补充
                    </div>
                </div>
                <div class="form-group">
