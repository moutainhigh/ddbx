            ...
            <div class="modal-dialog modal-lg" style="width: 900px;height: 800px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body"
                         style="height:450px;border:1px solid #ccc;background-color:#F7F7F7;border-radius: 10px;margin:30px;">
                ...
                for (var i = 1; i < data.zxlist.length; i++) {      //循环获取到的list
                    ...
                    for (var j = 0; j < imgstep1_1ssarr.length; j++) {       //根据图片存放的数组长度循环把图片放入td里面
                        ...
                        if(imgstep1_1ssarr[j]!=null&&imgstep1_1ssarr[j]!=''){
                            data1 = data1 + "<td   ><div class='col-sm-2'>" +
                                "<div style='position: relative;width: 100px;height:140px;display: inline-block;text-align: center;margin: auto;'" +
                    ...
                    $("#table").prepend('<tr normal="normal" style="word-wrap:break-word;word-break:break-all;width:100%;" class="gallerys"><td width="100px">第' + i + '次补件</td>' + data1 + '</tr>');
                    data1 = "";     //添加td后清空
                }
            },
            //执行失败或错误的回调函数
