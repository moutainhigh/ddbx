...
public class Manager {
     ...
     * 查询公司对应角色
     */
    @RequestMapping(value = "/manager/getagp", method = RequestMethod.POST)
    @ResponseBody
    public TtList getagp(long fsid) {
        String sql = "select * from admin_agp where fsid=" + fsid;
        TtList agplist = Tools.reclist(sql);
        return agplist;
    }
}