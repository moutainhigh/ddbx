 ...
 * @LastEditTime: 2019-01-21 09:56:03
 * @LastEditors: tt
 */
...
public class ManagerPage {
  public static void SetPageHtml(Map<String, Object> mso) {
    ...
    mso.put("web", info2);
    /* small */
    Map<String, String> infosmall = new HashMap<>();
   ...
   * @return string 分頁代碼
   */
  public static String getpage(int e, int now, int l) {
    String result = "";
    boolean auto_hide = true;
    Map<String, Object> mso = new HashMap<>();
    SetPageHtml(mso);
    Map<String, String> mss = (Map<String, String>) mso.get("admin");
    if (e > 1 || !auto_hide) {
      int f = 1;
      int n = now < e ? now + 1 : e;
      int p = now > f ? now - 1 : f;
